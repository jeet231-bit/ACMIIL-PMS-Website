...
const CLIENT: OnboardingCategory[] = [
  ...
  },
  {
    key: 'nre',
    label: 'NRE',
    note: 'For NRE accounts. “If any / if applicable” documents are optional.',
    docs: [
      ...
      { key: 'nre_indian_address', label: 'Self-attested Indian Address Proof (DL/Voter ID/Aadhaar, if any)', optional: true },
      { key: 'nre_passport', label: 'Valid self-attested Passport' },
      { key: 'nre_immigration', label: 'Latest Immigration Page (if visited India within 3 months)', optional: true },
      { key: 'nre_visa', label: 'Valid Visa / Work Permit (self-attested)' },
      { key: 'nre_residential', label: 'Residential Card (if any)', optional: true },
      { key: 'nre_oci', label: 'OCI/PIO card self-attested copy (if any)', optional: true },
  ...
  },
  {
    key: 'nro',
    label: 'NRO',
    note: 'For NRO accounts. “If any / if applicable” documents are optional.',
    docs: [
      ...
      { key: 'nro_indian_address', label: 'Self-attested Indian Address Proof (DL/Voter ID/Aadhaar, if any)', optional: true },
      { key: 'nro_passport', label: 'Valid self-attested Passport' },
      { key: 'nro_immigration', label: 'Latest Immigration Page (if visited India within 3 months)', optional: true },
      { key: 'nro_visa', label: 'Valid Visa / Work Permit (self-attested)' },
      { key: 'nro_residential', label: 'Residential Card (if any)', optional: true },
      { key: 'nro_oci', label: 'OCI/PIO card self-attested copy (if any)', optional: true },
